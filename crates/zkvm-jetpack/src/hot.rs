...
use crate::jets::compute_poly_jets::compute_composition_poly_jet;
...
pub const ZKVM_TABLE_JETS: &[HotEntry] = &[
    ...
    (
        &[
            K_138,
            Left(b"one"), Left(b"two"), Left(b"tri"), Left(b"qua"),
            Left(b"pen"), Left(b"stark-core"), Left(b"jetted-funcs"),
